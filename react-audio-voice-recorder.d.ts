...
declare module "react-audio-voice-recorder" {
    ...
    export const useAudioRecorder = (audioTrackConstraints?: MediaAudioTrackConstraints, onNotAllowedOrFound?: (exception: DOMException) => any, mediaRecorderOptions?: MediaRecorderOptions) => recorderControls;
}
