// taken from react-audio-voice-recorder source code - types don't export properly,
// so I have to type everything manually
...
export declare type useAudioRecorderType = (audioTrackConstraints?: MediaAudioTrackConstraints, onNotAllowedOrFound?: (exception: DOMException) => any, mediaRecorderOptions?: MediaRecorderOptions) => recorderControls;
